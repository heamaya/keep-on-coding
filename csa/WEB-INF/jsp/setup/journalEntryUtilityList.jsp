	...
	<d:table name="${journalEntryUtilityList}"  class="list" uid="row" pagesize="10" sort="list" requestURI="" export="false" excludedParams="*">
		<d:column title="Fecha" sortable="true" >
			<s:date name="%{#attr.row.created}" format="dd/MM/yyyy" />
 		</d:column>
	
	 	<d:column title="Nombre Archivo Entradas" sortable="true" >
			<s:property value="%{#attr.row.journalEntriesFileName}" />
 		</d:column>
