		...
		<tr>
			<td>
				...
				<sj:a cssClass="listButton" href="%{url}" targets="currentFormDiv" button="true" onCompleteTopics="openCurrentDialog" requestType="GET">
					...
					<s:div cssClass="button">
						<img src='<s:property value="%{#iconUrl}" />' title='Agregar Noticia' />
					</s:div>					
				</sj:a>
			</td>
			<td>
			...
			<td>
    			...
    			<sj:a cssClass="listButton" href="%{url}" targets="result" button="true" requestType="GET" onCompleteTopics="completeRefresh">
					...
					<s:div cssClass="button">
						<img src='<s:property value="%{#iconUrl}" />' title='Refrescar Listado de Noticias' />
					</s:div>					
    			</sj:a>
			</td>
			<td>
	...
	<sj:dialog id="currentDialog" width="1000" modal="true" draggable="true" position="center" resizable="true" title="Noticia" autoOpen="false" onBeforeTopics="beforeOpenCurrentDialog" onOpenTopics="onOpenCurrentDialog" zindex="1">
