...
<s:form id="quickNearestProvinceForm" action="%{mappedRequest}" cssClass="ui-dialog-content">	
	...
	<s:if test='actionMethod == "update"'>	
		...
		<script type="text/javascript">
			$("#quickNearestProvinceForm").validate({
				rules: {
					provinceName: {
						required:true,
						maxlength:512
				...
				submitHandler: function(form) {
					$(form).ajaxSubmit({
						...
						success: function(provinces) {
							var selectedId = $("#nearestProvince").val();
			    		    var options = '<option value=""></option>';
				    	  	...
				    	  	$("#nearestProvince").html(options);
							$(".quickNearestProvinceButton").button("enable");
							$("#quickNearestProvinceFormDialog").dialog("destroy");
							$("#nearestProvince").selectmenu({style:"dropdown", width:480});
						},
						beforeSerialize: function(form, options) { 
							$(form).attr("requestId", $("#nearestProvince").val());
						},
						dataType:"json"
					});
				}
