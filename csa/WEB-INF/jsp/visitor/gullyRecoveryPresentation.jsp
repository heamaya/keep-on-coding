	...
	<h1 class="title">
		<s:text name="gulliesRecovery" />
	</h1>
	<div>
		<p class="paragraph">
			&nbsp;&nbsp;&nbsp;&nbsp;<s:text name="gulliesRecoveryDefinition" /> <a id="more" href="#"><s:text name="more" /></a> 
		</p>	
	</div>
	
	<div id="details" >
		<p class="paragraph">
			&nbsp; &nbsp; &nbsp; &nbsp;<s:text name="gulliesRecoveryDetails" />
		</p>
	</div>
		    	...
		    	<s:if test="#request.presentationPhotos != null">
					<s:iterator value="#request.presentationPhotos">
				        <li>
				        	...
				        	<s:url id="url" action="GullyRecoveryPresentationPhotoDownloadFileAction_getFile" namespace="/Util" escapeAmp="false">
	...
	<script type="text/javascript">
		...
		$(
			function() {
				...
				if(language == "es") {
					photosDialogTitle="Fotos de Recuperación de Cárcavas";
	  				moreInfoDialogTitle = "Más Información Sobre Recuperación de Cárcavas";
	  			} else if(language == "pt") {
					photosDialogTitle= "Fotos de Recuperação de Voçorocas";
	  				moreInfoDialogTitle = "Mais Informação Sob Recuperação de Voçorocas";
	  			} else {
	  				photosDialogTitle = "Gullies Recovery Photos";
	  				moreInfoDialogTitle = "More Information About Gullies Recovery";
	  			}
