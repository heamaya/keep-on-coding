	...
	<div class="universalMenuButton ui-corner-all">	
		<s:text name="start" /> &gt; <s:a href="%{homePresentationActionUrl}" ><s:text name="presentation" /></s:a> | <s:a href="%{videosPresentationActionUrl}"><s:text name="videos" /></s:a> | <s:a href="%{newsPresentationActionUrl}"><s:text name="news" /></s:a> ||
