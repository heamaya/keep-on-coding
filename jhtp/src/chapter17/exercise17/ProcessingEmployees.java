...
public class ProcessingEmployees {
   public static void main(String[] args) {
      ...
      System.out.println("Average employee salary by department: ");
      Map<String, Double> employeeAverageSalaryByDepartment =
    	list.stream()
      		.collect(Collectors.groupingBy(Employee::getDepartment, 
      			Collectors.averagingDouble(Employee::getSalary)));
      
      employeeAverageSalaryByDepartment.forEach(
    	(department, salary) -> {
    		System.out.printf("%s: %s, %s: $%,.2f%n", "Department", department, "Salary", salary);
    	});
